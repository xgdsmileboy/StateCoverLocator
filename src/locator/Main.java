...
public class Main {
	...
	private static void trainModel(Subject subject) {
		...
		String targetVarPath = Constant.STR_ML_VAR_OUT_FILE_PATH + "/" + subject.getName() + "/var/" + subject.getName()
				+ "_" + subject.getId() + ".var.csv";
		String targetExprPath = Constant.STR_ML_VAR_OUT_FILE_PATH + "/" + subject.getName() + "/expr/"
...
//		printCoverage(predicateCoverage, Constant.STR_INFO_OUT_PATH + "/" + subject.getName() + "/" + subject.getName() + "_"
