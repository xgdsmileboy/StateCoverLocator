 ...
 * @date Jun 2, 2017
 */
public class CfgInstrument extends TraversalVisitor {

	private final static String __name__ = "@CfgInstrument ";

	public CfgInstrument() {
	}

	public CfgInstrument(String methodFlag) {
		_methodFlag = methodFlag;
	}

	public CfgInstrument(Set<Integer> methods) {
		_methods = methods;
	}
