...
class Configure(object):
    ...
    def get_raw_var_train_in_file(self):
        ...
        # return self.__input_base_path__ + '/' + self.__project_name__ + '_' + self.__bug_id__ + '.var.csv'
    ...
    def get_raw_expr_train_in_file(self):
        ...
        # return self.__input_base_path__ + '/' + self.__project_name__ + '_' + self.__bug_id__ + '.expr.csv'
