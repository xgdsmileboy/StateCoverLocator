...
package jdk7.com.sun.tools.javac.api;
...
import jdk7.com.sun.source.tree.Scope;
import jdk7.com.sun.source.tree.Tree;
import jdk7.com.sun.source.util.SourcePositions;
import jdk7.com.sun.source.util.TreePath;
import jdk7.com.sun.source.util.Trees;
...
import jdk7.com.sun.tools.javac.comp.MemberEnter;
...
import jdk7.com.sun.tools.javac.tree.TreeCopier;
...
import jdk7.javax.lang.model.type.TypeMirror;
...
public class JavacTrees extends Trees {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof jdk7.com.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (jdk7.com.sun.tools.javac.code.Type)type, (Symbol)member);
        } else
            return false;
    }
