...
import jdk7.com.sun.source.util.JavacTask;
...
import jdk7.com.sun.tools.javac.main.CommandLine;
import jdk7.com.sun.tools.javac.main.JavaCompiler;
import jdk7.com.sun.tools.javac.main.Main;
...
import jdk7.com.sun.tools.javac.util.ClientCodeException;
...
public class JavacTaskImpl extends JavacTask {
    ...
    private void prepareCompiler() throws IOException {
        if (!used.getAndSet(true)) {
            ...
            jdk7.com.sun.tools.javac.parser.DocCommentScanner.Factory.preRegister(context);
    ...
    public Iterable<? extends CompilationUnitTree> parse() throws IOException {
        try {
            ...
            return (Iterable<? extends CompilationUnitTree>) units;
        }
        finally {
            parsed = true;
