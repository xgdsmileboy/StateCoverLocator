...
import jdk7.com.sun.tools.javac.file.RelativePath.RelativeDirectory;
import jdk7.com.sun.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public jdk7.com.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        lock.lock();
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            jdk7.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return jdk7.com.sun.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public List<String> getDirectories(RelativeDirectory path) {
        ...
        try {
            ...
            DirectoryEntry de = directories.get(path);
            jdk7.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private jdk7.com.sun.tools.javac.util.List<String> zipFileEntriesFiles = jdk7.com.sun.tools.javac.util.List.<String>nil();
        private jdk7.com.sun.tools.javac.util.List<String> zipFileEntriesDirectories = jdk7.com.sun.tools.javac.util.List.<String>nil();
        private jdk7.com.sun.tools.javac.util.List<Entry>  zipFileEntries = jdk7.com.sun.tools.javac.util.List.<Entry>nil();
        ...
        private jdk7.com.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private jdk7.com.sun.tools.javac.util.List<String> getDirectories() {
        ...
        private jdk7.com.sun.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = jdk7.com.sun.tools.javac.util.List.nil();
