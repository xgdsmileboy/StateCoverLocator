...
package jdk7.com.sun.tools.javac.jvm;
import static jdk7.com.sun.tools.javac.code.Flags.ABSTRACT;
import static jdk7.com.sun.tools.javac.code.Flags.FINAL;
import static jdk7.com.sun.tools.javac.code.Flags.INTERFACE;
import static jdk7.com.sun.tools.javac.code.Flags.IPROXY;
import static jdk7.com.sun.tools.javac.code.Flags.PRIVATE;
import static jdk7.com.sun.tools.javac.code.Flags.STATIC;
import static jdk7.com.sun.tools.javac.code.Flags.SYNTHETIC;
import static jdk7.com.sun.tools.javac.code.Kinds.MTH;
import static jdk7.com.sun.tools.javac.code.Kinds.TYP;
import static jdk7.com.sun.tools.javac.code.Kinds.VAR;
import static jdk7.com.sun.tools.javac.code.TypeTags.ARRAY;
import static jdk7.com.sun.tools.javac.code.TypeTags.CLASS;
import static jdk7.com.sun.tools.javac.code.TypeTags.INT;
import static jdk7.com.sun.tools.javac.code.TypeTags.METHOD;
import static jdk7.com.sun.tools.javac.code.TypeTags.VOID;
import static jdk7.com.sun.tools.javac.code.TypeTags.lastBaseTag;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.BYTEcode;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.CHARcode;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.DOUBLEcode;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.FLOATcode;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.INTcode;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.LONGcode;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.SHORTcode;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.aconst_null;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.arraylength;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.athrow;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.checkcast;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.dconst_0;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.dup;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.dup_x1;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.fconst_0;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.goto_;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.iadd;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.iconst_0;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.iconst_m1;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.if_acmp_nonnull;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.if_acmp_null;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.if_acmpeq;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.if_acmpne;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.if_icmpeq;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.if_icmple;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.ifeq;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.instanceof_;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.int2byte;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.ireturn;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.ishl;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.ishll;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.isub;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.jsr;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.lconst_0;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.ldc2;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.lookupswitch;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.lushrl;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.monitorenter;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.monitorexit;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.new_;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.pop;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.preShift;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.ret;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.return_;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.string_add;
import static jdk7.com.sun.tools.javac.jvm.ByteCodes.tableswitch;
import static jdk7.com.sun.tools.javac.jvm.CRTFlags.CRT_BLOCK;
import static jdk7.com.sun.tools.javac.jvm.CRTFlags.CRT_FLOW_CONTROLLER;
import static jdk7.com.sun.tools.javac.jvm.CRTFlags.CRT_FLOW_TARGET;
import static jdk7.com.sun.tools.javac.jvm.CRTFlags.CRT_STATEMENT;

import jdk7.com.sun.source.tree.Tree;

import jdk7.com.sun.tools.javac.code.Flags;
import jdk7.com.sun.tools.javac.code.Scope;
import jdk7.com.sun.tools.javac.code.Source;
import jdk7.com.sun.tools.javac.code.Symbol;
import jdk7.com.sun.tools.javac.code.Symtab;
import jdk7.com.sun.tools.javac.code.Type;
import jdk7.com.sun.tools.javac.code.TypeTags;
import jdk7.com.sun.tools.javac.code.Types;
import jdk7.com.sun.tools.javac.code.Symbol.ClassSymbol;
import jdk7.com.sun.tools.javac.code.Symbol.CompletionFailure;
import jdk7.com.sun.tools.javac.code.Symbol.MethodSymbol;
import jdk7.com.sun.tools.javac.code.Symbol.OperatorSymbol;
import jdk7.com.sun.tools.javac.code.Symbol.TypeSymbol;
import jdk7.com.sun.tools.javac.code.Symbol.VarSymbol;
import jdk7.com.sun.tools.javac.code.Type.MethodType;
import jdk7.com.sun.tools.javac.comp.AttrContext;
import jdk7.com.sun.tools.javac.comp.Check;
import jdk7.com.sun.tools.javac.comp.Env;
import jdk7.com.sun.tools.javac.comp.Resolve;
import jdk7.com.sun.tools.javac.jvm.Code.Chain;
import jdk7.com.sun.tools.javac.jvm.Code.StackMapFormat;
import jdk7.com.sun.tools.javac.jvm.Items.CondItem;
import jdk7.com.sun.tools.javac.jvm.Items.Item;
import jdk7.com.sun.tools.javac.jvm.Items.LocalItem;
import jdk7.com.sun.tools.javac.tree.JCTree;
import jdk7.com.sun.tools.javac.tree.TreeInfo;
import jdk7.com.sun.tools.javac.tree.TreeMaker;
import jdk7.com.sun.tools.javac.tree.TreeScanner;
import jdk7.com.sun.tools.javac.tree.JCTree.JCArrayAccess;
import jdk7.com.sun.tools.javac.tree.JCTree.JCAssert;
import jdk7.com.sun.tools.javac.tree.JCTree.JCAssign;
import jdk7.com.sun.tools.javac.tree.JCTree.JCAssignOp;
import jdk7.com.sun.tools.javac.tree.JCTree.JCBinary;
import jdk7.com.sun.tools.javac.tree.JCTree.JCBlock;
import jdk7.com.sun.tools.javac.tree.JCTree.JCBreak;
import jdk7.com.sun.tools.javac.tree.JCTree.JCCase;
import jdk7.com.sun.tools.javac.tree.JCTree.JCCatch;
import jdk7.com.sun.tools.javac.tree.JCTree.JCClassDecl;
import jdk7.com.sun.tools.javac.tree.JCTree.JCCompilationUnit;
import jdk7.com.sun.tools.javac.tree.JCTree.JCConditional;
import jdk7.com.sun.tools.javac.tree.JCTree.JCContinue;
import jdk7.com.sun.tools.javac.tree.JCTree.JCDoWhileLoop;
import jdk7.com.sun.tools.javac.tree.JCTree.JCEnhancedForLoop;
import jdk7.com.sun.tools.javac.tree.JCTree.JCExpression;
import jdk7.com.sun.tools.javac.tree.JCTree.JCExpressionStatement;
import jdk7.com.sun.tools.javac.tree.JCTree.JCFieldAccess;
import jdk7.com.sun.tools.javac.tree.JCTree.JCForLoop;
import jdk7.com.sun.tools.javac.tree.JCTree.JCIdent;
import jdk7.com.sun.tools.javac.tree.JCTree.JCIf;
import jdk7.com.sun.tools.javac.tree.JCTree.JCInstanceOf;
import jdk7.com.sun.tools.javac.tree.JCTree.JCLabeledStatement;
import jdk7.com.sun.tools.javac.tree.JCTree.JCLiteral;
import jdk7.com.sun.tools.javac.tree.JCTree.JCMethodDecl;
import jdk7.com.sun.tools.javac.tree.JCTree.JCMethodInvocation;
import jdk7.com.sun.tools.javac.tree.JCTree.JCNewArray;
import jdk7.com.sun.tools.javac.tree.JCTree.JCNewClass;
import jdk7.com.sun.tools.javac.tree.JCTree.JCParens;
import jdk7.com.sun.tools.javac.tree.JCTree.JCReturn;
import jdk7.com.sun.tools.javac.tree.JCTree.JCSkip;
import jdk7.com.sun.tools.javac.tree.JCTree.JCStatement;
import jdk7.com.sun.tools.javac.tree.JCTree.JCSwitch;
import jdk7.com.sun.tools.javac.tree.JCTree.JCSynchronized;
import jdk7.com.sun.tools.javac.tree.JCTree.JCThrow;
import jdk7.com.sun.tools.javac.tree.JCTree.JCTry;
import jdk7.com.sun.tools.javac.tree.JCTree.JCTypeCast;
import jdk7.com.sun.tools.javac.tree.JCTree.JCUnary;
import jdk7.com.sun.tools.javac.tree.JCTree.JCVariableDecl;
import jdk7.com.sun.tools.javac.tree.JCTree.JCWhileLoop;
import jdk7.com.sun.tools.javac.tree.JCTree.JCWildcard;
import jdk7.com.sun.tools.javac.tree.JCTree.LetExpr;
import jdk7.com.sun.tools.javac.util.Context;
import jdk7.com.sun.tools.javac.util.List;
import jdk7.com.sun.tools.javac.util.ListBuffer;
import jdk7.com.sun.tools.javac.util.Log;
import jdk7.com.sun.tools.javac.util.Name;
import jdk7.com.sun.tools.javac.util.Options;
import jdk7.com.sun.tools.javac.util.Position;
import jdk7.com.sun.tools.javac.util.JCDiagnostic.DiagnosticPosition;
